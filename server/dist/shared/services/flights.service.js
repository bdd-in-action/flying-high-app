...
let FlightsService = class FlightsService {
    constructor(http, authService, usersService) {
        ...
        this.cityList = [
            ...
            { name: 'San Francisco', point: 142, short: 'SFO', region: 'AM' },
            { name: 'New York', point: 150, short: 'JFK', region: 'AM' },
            { name: 'Los Angeles', point: 147, short: 'LAX', region: 'AM' },
            { name: 'Toronto', point: 132, short: 'YYZ', region: 'AM' },
            { name: 'Singapore', point: 162, short: 'SIN', region: 'ASIA' },
            { name: 'Hong Kong', point: 188, short: 'HKG', region: 'ASIA' },
            { name: 'Seattle', point: 122, short: 'SEA', region: 'AM' },
            { name: 'Shanghai', point: 167, short: 'PVG', region: 'ASIA' },
            { name: 'Seoul', point: 132, short: 'ICN', region: 'ASIA' },
        ];
        this.pointsEarned = new Map([
            ['ANZ-EUR', 250],
            ['EUR-ANZ', 250],
            ['ANZ-AM', 150],
            ['AM-ANZ', 150],
        ...
        this.cabinClassPointWeight = new Map([
            ['Economy', 1.0],
            ['Premium Economy', 1.5],
            ['Business', 2.0],
        ]);
    ...
    createFlight(flight) {
        ...
        flight = Object.assign(Object.assign({}, flight), { points: this.usersService.updateUserPointsAndLevel(this.authService.getAuthUser(), earnedPoints), orderNumber: this.generateRandomString(8) });
